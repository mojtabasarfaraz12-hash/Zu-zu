...
export const metadata = {
  title: "Impressum | Zusammen Zuhause GmbH",
};
        ...
        <div className="bg-white rounded-2xl border border-gray-100 p-10 shadow-sm">
          <div className="flex flex-col items-center justify-center py-16 text-center">
            ...
            <p className="text-[#6B7063] max-w-md leading-relaxed">
              Der vollständige Impressums-Inhalt wird hier hinterlegt, sobald
      ...
      <footer className="border-t border-gray-100 py-6 mt-8">
        <div className="max-w-4xl mx-auto px-6 flex flex-col sm:flex-row items-center justify-between gap-3 text-sm text-[#6B7063]">
          ...
          <div className="flex gap-5">
            <Link href="/impressum" className="text-[#1B4D2E] font-medium">
              Impressum
            </Link>
            <Link href="/datenschutz" className="hover:text-[#1B4D2E] transition-colors">
              Datenschutz
            </Link>
          </div>
        </div>
